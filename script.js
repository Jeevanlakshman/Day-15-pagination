...
heading.innerText="The Details of shotlisted candidates"
document.body.append(heading)


var div= document.createElement("div")
div.setAttribute("class","pagination")
div.innerHTML=`<a href="#" id="start" onclick="foo()">&laquo;</a>
               <a href="#" onclick="foo1()">1</a>
               <a href="#" onclick="foo2()">2</a>
               <a href="#" onclick="foo3()">3</a>
               <a href="#" onclick="foo4()">4</a>
               <a href="#" onclick="foo5()">5</a>
               <a href="#" id="end" onclick="foo6()">&raquo;</a>`


document.body.append(div)

var par=document.createElement("span")
par.setAttribute("id","display")
document.body.append(par)


function foo(){
  alert("The page is start")
}foo()



function foo1(){
   var res1=document.getElementById("display")
   res1.innerText=`[
    {
      "id": "1",
      "name": "Lura Senger",
...
function foo3(){
  var res3=document.getElementById("display")
  res3.innerText=`[{
    "id": "41",
...
function foo4(){
  var res4=document.getElementById("display")
  res4.innerText=`[{
    "id": "61",
...
function foo5(){
  var res5=document.getElementById("display")
  res5.innerText=`[{
    "id": "81",
    "name": "Carey Kiehn",
